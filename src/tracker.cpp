...
namespace pump
{
    ...
    void Tracker::saveStats(CaptureConfig* config)
    {
        ...
        fprintf(f,  "Src, Dst, Stream No., Protocol, #pkt, duration,"
                    "#pkt_fwd, pkt_fwd/sec, bytes_fwd/sec, duration_fwd,"
                    "pkt_len_fwd_max, pkt_len_fwd_min, pkt_len_fwd_avg, iat_fwd_max, iat_fwd_min, iat_fwd_avg,"
                    "#pkt_rev, pkt_rev/sec, bytes_rev/sec, duration_rev,"
                    ...
                    "%%tcp_zero_win_fwd, %%tcp_zero_win_probe_fwd, %%tcp_zero_win_probe_ack_fwd,"
                    ...
                    "%%tcp_zero_win_rev, %%tcp_zero_win_probe_rev, %%tcp_zero_win_probe_ack_rev,"
